 ...
 */
export type FFAccountDeliveriesUpdateDeliveryStatusMutationRequestType = UpdateDeliveryStatusDtoType

export type FFAccountDeliveriesUpdateDeliveryStatusMutationResponseType = FFAccountDeliveriesUpdateDeliveryStatus200Type
...
export type FFAccountDeliveriesUpdateDeliveryStatusTypeMutation = {
  ...
  Errors: FFAccountDeliveriesUpdateDeliveryStatus400Type | FFAccountDeliveriesUpdateDeliveryStatus404Type
}