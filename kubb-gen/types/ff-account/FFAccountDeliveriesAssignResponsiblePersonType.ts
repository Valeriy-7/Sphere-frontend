 ...
 */
export type FFAccountDeliveriesAssignResponsiblePersonMutationRequestType =
  AssignResponsiblePersonDtoType;

export type FFAccountDeliveriesAssignResponsiblePersonMutationResponseType =
  FFAccountDeliveriesAssignResponsiblePerson200Type;
