 ...
 */
export type FFAccountDeliveriesUpdateDeliveryDetailsMutationRequestType =
  UpdateDeliveryDetailsDtoType;

export type FFAccountDeliveriesUpdateDeliveryDetailsMutationResponseType =
