...
export type DiagnosticsTestDnsResolverQueryKey = ReturnType<typeof diagnosticsTestDnsResolverQueryKey>
 ...
 */
export async function diagnosticsTestDnsResolver(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function diagnosticsTestDnsResolverQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  options: {
    query?: Partial<QueryObserverOptions<DiagnosticsTestDnsResolverQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
