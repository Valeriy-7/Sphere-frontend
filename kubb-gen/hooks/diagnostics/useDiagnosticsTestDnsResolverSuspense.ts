...
export const diagnosticsTestDnsResolverSuspenseQueryKey = () =>
  [{ url: '/diagnostics/dns-test' }] as const;

export type DiagnosticsTestDnsResolverSuspenseQueryKey = ReturnType<
  typeof diagnosticsTestDnsResolverSuspenseQueryKey
>;
 ...
 */
export async function diagnosticsTestDnsResolverSuspense(
...
export function diagnosticsTestDnsResolverSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
