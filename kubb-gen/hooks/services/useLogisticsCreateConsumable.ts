...
export const logisticsCreateConsumableMutationKey = () =>
  [{ url: '/services/consumables' }] as const;

export type LogisticsCreateConsumableMutationKey = ReturnType<
  typeof logisticsCreateConsumableMutationKey
>;
...
export async function logisticsCreateConsumable(
  ...
  config: Partial<RequestConfig<LogisticsCreateConsumableMutationRequestType>> & {
