...
export const deliveryPointsGetAllDeliveryPointsSuspenseQueryKey = () => [{ url: '/services/delivery-points/all' }] as const

export type DeliveryPointsGetAllDeliveryPointsSuspenseQueryKey = ReturnType<typeof deliveryPointsGetAllDeliveryPointsSuspenseQueryKey>
 ...
 */
export async function deliveryPointsGetAllDeliveryPointsSuspense(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
  const { client: request = client, ...requestConfig } = config

  const res = await request<DeliveryPointsGetAllDeliveryPointsQueryResponseType, ResponseErrorConfig<Error>, unknown>({
    method: 'GET',
...
export function deliveryPointsGetAllDeliveryPointsSuspenseQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  options: {
    query?: Partial<UseSuspenseQueryOptions<DeliveryPointsGetAllDeliveryPointsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryKey>>
  ...
  const query = useSuspenseQuery({
    ...(deliveryPointsGetAllDeliveryPointsSuspenseQueryOptions(config) as unknown as UseSuspenseQueryOptions),
    queryKey,
