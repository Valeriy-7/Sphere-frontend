...
export function useLogisticsDeleteService(
  options: {
    mutation?: UseMutationOptions<LogisticsDeleteServiceMutationResponseType, ResponseErrorConfig<Error>, { id: LogisticsDeleteServicePathParamsType['id'] }>
  ...
  return useMutation<LogisticsDeleteServiceMutationResponseType, ResponseErrorConfig<Error>, { id: LogisticsDeleteServicePathParamsType['id'] }>({
    mutationFn: async ({ id }) => {
