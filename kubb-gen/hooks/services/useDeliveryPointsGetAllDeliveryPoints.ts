...
export const deliveryPointsGetAllDeliveryPointsQueryKey = () => [{ url: '/services/delivery-points/all' }] as const

export type DeliveryPointsGetAllDeliveryPointsQueryKey = ReturnType<typeof deliveryPointsGetAllDeliveryPointsQueryKey>
 ...
 */
export async function deliveryPointsGetAllDeliveryPoints(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function deliveryPointsGetAllDeliveryPointsQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  options: {
    query?: Partial<QueryObserverOptions<DeliveryPointsGetAllDeliveryPointsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
