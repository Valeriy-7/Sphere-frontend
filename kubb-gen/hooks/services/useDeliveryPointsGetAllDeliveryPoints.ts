...
export const deliveryPointsGetAllDeliveryPointsQueryKey = (params?: DeliveryPointsGetAllDeliveryPointsQueryParamsType) =>
...
>(
  ...
  const query = useQuery({
    ...(deliveryPointsGetAllDeliveryPointsQueryOptions(params, config) as unknown as QueryObserverOptions),
    queryKey,
