...
export const logisticsUpdateLogisticsMutationKey = () =>
  [{ url: '/services/logistics/{id}' }] as const;

export type LogisticsUpdateLogisticsMutationKey = ReturnType<
  typeof logisticsUpdateLogisticsMutationKey
>;
...
export async function logisticsUpdateLogistics(
  ...
  config: Partial<RequestConfig<LogisticsUpdateLogisticsMutationRequestType>> & {
 ...
 * {@link /services/logistics/:id}
 */
export function useLogisticsUpdateLogistics<TContext>(
  options: {
    mutation?: UseMutationOptions<
      ...
      TContext
    >;
    client?: Partial<RequestConfig<LogisticsUpdateLogisticsMutationRequestType>> & {
      client?: typeof client;
    };
  } = {},
) {
