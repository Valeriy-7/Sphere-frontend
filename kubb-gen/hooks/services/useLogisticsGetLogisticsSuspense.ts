...
export const logisticsGetLogisticsSuspenseQueryKey = () =>
  [{ url: '/services/logistics' }] as const;

export type LogisticsGetLogisticsSuspenseQueryKey = ReturnType<
  typeof logisticsGetLogisticsSuspenseQueryKey
>;
 ...
 */
export async function logisticsGetLogisticsSuspense(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
  const { client: request = client, ...requestConfig } = config;

  const res = await request<
    LogisticsGetLogisticsQueryResponseType,
...
export function logisticsGetLogisticsSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
