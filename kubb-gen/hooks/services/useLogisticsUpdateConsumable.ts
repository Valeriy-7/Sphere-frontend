...
export const logisticsUpdateConsumableMutationKey = () =>
  [{ url: '/services/consumables/{id}' }] as const;

export type LogisticsUpdateConsumableMutationKey = ReturnType<
  typeof logisticsUpdateConsumableMutationKey
>;
...
export async function logisticsUpdateConsumable(
  ...
  config: Partial<RequestConfig<LogisticsUpdateConsumableMutationRequestType>> & {
