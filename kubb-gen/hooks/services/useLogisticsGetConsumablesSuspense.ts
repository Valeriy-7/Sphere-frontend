...
export const logisticsGetConsumablesSuspenseQueryKey = () =>
  [{ url: '/services/consumables' }] as const;

export type LogisticsGetConsumablesSuspenseQueryKey = ReturnType<
  typeof logisticsGetConsumablesSuspenseQueryKey
>;
 ...
 */
export async function logisticsGetConsumablesSuspense(
...
export function logisticsGetConsumablesSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
