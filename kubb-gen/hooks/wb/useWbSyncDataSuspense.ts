 ...
 * {@link /wb/sync-data}
 */
export async function wbSyncDataSuspense(params: WbSyncDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbSyncDataSuspenseQueryOptions(params: WbSyncDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<UseSuspenseQueryOptions<WbSyncDataQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryKey>>
