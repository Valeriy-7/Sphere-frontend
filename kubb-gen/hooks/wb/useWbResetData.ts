...
export const wbResetDataQueryKey = (params: WbResetDataQueryParamsType) => [{ url: '/wb/reset-data' }, ...(params ? [params] : [])] as const
 ...
 * {@link /wb/reset-data}
 */
export async function wbResetData(params: WbResetDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbResetDataQueryOptions(params: WbResetDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
  const queryKey = wbResetDataQueryKey(params)
  return queryOptions<WbResetDataQueryResponseType, ResponseErrorConfig<Error>, WbResetDataQueryResponseType, typeof queryKey>({
    enabled: !!params,
    queryKey,
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<WbResetDataQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
