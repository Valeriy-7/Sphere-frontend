 ...
 * {@link /wb/products}
 */
export async function wbGetProducts(params: WbGetProductsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbGetProductsQueryOptions(params: WbGetProductsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<WbGetProductsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
