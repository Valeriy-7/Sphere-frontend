...
export const wbLoadDemoDataQueryKey = (params: WbLoadDemoDataQueryParamsType) => [{ url: '/wb/load-demo-data' }, ...(params ? [params] : [])] as const
 ...
 */
export async function wbLoadDemoData(params: WbLoadDemoDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbLoadDemoDataQueryOptions(params: WbLoadDemoDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<WbLoadDemoDataQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
