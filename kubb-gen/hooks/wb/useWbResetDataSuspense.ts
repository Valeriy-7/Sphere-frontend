 ...
 * {@link /wb/reset-data}
 */
export async function wbResetDataSuspense(params: WbResetDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbResetDataSuspenseQueryOptions(params: WbResetDataQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<UseSuspenseQueryOptions<WbResetDataQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryKey>>
