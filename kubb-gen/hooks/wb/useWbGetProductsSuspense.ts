 ...
 * {@link /wb/products}
 */
export async function wbGetProductsSuspense(params: WbGetProductsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbGetProductsSuspenseQueryOptions(params: WbGetProductsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
  const queryKey = wbGetProductsSuspenseQueryKey(params)
  return queryOptions<WbGetProductsQueryResponseType, ResponseErrorConfig<Error>, WbGetProductsQueryResponseType, typeof queryKey>({
    enabled: !!params,
    queryKey,
...
>(
  ...
  options: {
    query?: Partial<UseSuspenseQueryOptions<WbGetProductsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryKey>>
