 ...
 * {@link /wb/sync-logs}
 */
export async function wbGetSyncLogs(params: WbGetSyncLogsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function wbGetSyncLogsQueryOptions(params: WbGetSyncLogsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<WbGetSyncLogsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
