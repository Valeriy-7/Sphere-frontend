...
export const wbGetSyncLogsSuspenseQueryKey = (params: WbGetSyncLogsQueryParamsType) =>
 ...
 * {@link /wb/sync-logs}
 */
export async function wbGetSyncLogsSuspense(
...
export function wbGetSyncLogsSuspenseQueryOptions(
  params: WbGetSyncLogsQueryParamsType,
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
