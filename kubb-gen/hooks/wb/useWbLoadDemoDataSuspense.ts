...
export const wbLoadDemoDataSuspenseQueryKey = (params: WbLoadDemoDataQueryParamsType) =>
 ...
 */
export async function wbLoadDemoDataSuspense(
...
export function wbLoadDemoDataSuspenseQueryOptions(
  params: WbLoadDemoDataQueryParamsType,
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
