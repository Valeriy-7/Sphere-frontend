 ...
 * {@link /users/settings}
 */
export async function usersGetUserSettings(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function usersGetUserSettingsQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  options: {
    query?: Partial<QueryObserverOptions<UsersGetUserSettingsQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
