...
export type UsersGetUserSettingsSuspenseQueryKey = ReturnType<
  typeof usersGetUserSettingsSuspenseQueryKey
>;
 ...
 * {@link /users/settings}
 */
export async function usersGetUserSettingsSuspense(
...
export function usersGetUserSettingsSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
