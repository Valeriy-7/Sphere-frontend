...
export const FFDeliveriesGetFFDeliveriesSuspenseQueryKey = (params?: FFDeliveriesGetFFDeliveriesQueryParamsType) =>
  [{ url: '/ff-deliveries' }, ...(params ? [params] : [])] as const

export type FFDeliveriesGetFFDeliveriesSuspenseQueryKey = ReturnType<typeof FFDeliveriesGetFFDeliveriesSuspenseQueryKey>
...
export async function FFDeliveriesGetFFDeliveriesSuspense(
  ...
  const res = await request<FFDeliveriesGetFFDeliveriesQueryResponseType, ResponseErrorConfig<FFDeliveriesGetFFDeliveries401Type>, unknown>({
    method: 'GET',
    url: `/ff-deliveries`,
    params,
    ...requestConfig,
...
>(
  ...
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<FFDeliveriesGetFFDeliveriesQueryResponseType, ResponseErrorConfig<FFDeliveriesGetFFDeliveries401Type>, TData, TQueryKey>
    >
  ...
  const query = useSuspenseQuery({
    ...(FFDeliveriesGetFFDeliveriesSuspenseQueryOptions(params, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<FFDeliveriesGetFFDeliveries401Type>> & { queryKey: TQueryKey }
