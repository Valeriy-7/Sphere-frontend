...
export type FFDeliveriesGetFFDeliveryProductsSuspenseQueryKey = ReturnType<typeof FFDeliveriesGetFFDeliveryProductsSuspenseQueryKey>
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? FFDeliveriesGetFFDeliveryProductsSuspenseQueryKey(id, params)

  const query = useSuspenseQuery({
    ...(FFDeliveriesGetFFDeliveryProductsSuspenseQueryOptions(id, params, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
