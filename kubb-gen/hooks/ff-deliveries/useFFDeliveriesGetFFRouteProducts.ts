...
export const FFDeliveriesGetFFRouteProductsQueryKey = (
  id: FFDeliveriesGetFFRouteProductsPathParamsType['id'],
) => [{ url: '/ff-deliveries/route/:id/products', params: { id: id } }] as const;

export type FFDeliveriesGetFFRouteProductsQueryKey = ReturnType<
  typeof FFDeliveriesGetFFRouteProductsQueryKey
>;
