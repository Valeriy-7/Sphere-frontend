...
export const FFDeliveriesGetFFRouteProductsSuspenseQueryKey = (
  id: FFDeliveriesGetFFRouteProductsPathParamsType['id'],
) => [{ url: '/ff-deliveries/route/:id/products', params: { id: id } }] as const;

export type FFDeliveriesGetFFRouteProductsSuspenseQueryKey = ReturnType<
  typeof FFDeliveriesGetFFRouteProductsSuspenseQueryKey
>;
