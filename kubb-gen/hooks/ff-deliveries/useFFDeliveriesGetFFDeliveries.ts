...
export const FFDeliveriesGetFFDeliveriesQueryKey = (params?: FFDeliveriesGetFFDeliveriesQueryParamsType) =>
  [{ url: '/ff-deliveries' }, ...(params ? [params] : [])] as const

export type FFDeliveriesGetFFDeliveriesQueryKey = ReturnType<typeof FFDeliveriesGetFFDeliveriesQueryKey>
...
>(
  ...
  options: {
    query?: Partial<
      QueryObserverOptions<FFDeliveriesGetFFDeliveriesQueryResponseType, ResponseErrorConfig<FFDeliveriesGetFFDeliveries401Type>, TData, TQueryData, TQueryKey>
    >
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<FFDeliveriesGetFFDeliveries401Type>> & { queryKey: TQueryKey }
