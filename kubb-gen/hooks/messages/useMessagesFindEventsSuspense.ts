...
export const messagesFindEventsSuspenseQueryKey = (params: MessagesFindEventsQueryParamsType) =>
  [{ url: '/messages/events' }, ...(params ? [params] : [])] as const
 ...
 */
export async function messagesFindEventsSuspense(params: MessagesFindEventsQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  const query = useSuspenseQuery({
    ...(messagesFindEventsSuspenseQueryOptions(params, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
