...
export const messagesFindEventsQueryKey = (params: MessagesFindEventsQueryParamsType) =>
...
export async function messagesFindEvents(
  ...
  const res = await request<MessagesFindEventsQueryResponseType, ResponseErrorConfig<any>, unknown>(
    {
      method: 'GET',
