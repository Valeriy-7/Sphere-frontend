...
import type { MessagesFindAttachmentsQueryResponseType, MessagesFindAttachmentsQueryParamsType } from '../../types/messages/MessagesFindAttachmentsType'
import { queryOptions, useSuspenseQuery } from '@tanstack/react-query'

export const messagesFindAttachmentsSuspenseQueryKey = (params: MessagesFindAttachmentsQueryParamsType) =>
...
>(
  ...
  const query = useSuspenseQuery({
    ...(messagesFindAttachmentsSuspenseQueryOptions(params, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
