...
export const messagesFindAllSuspenseQueryKey = (params: MessagesFindAllQueryParamsType) => [{ url: '/messages' }, ...(params ? [params] : [])] as const
 ...
 * {@link /messages}
 */
export async function messagesFindAllSuspense(params: MessagesFindAllQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function messagesFindAllSuspenseQueryOptions(params: MessagesFindAllQueryParamsType, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
