 ...
 * {@link /chats/:id}
 */
export async function chatsFindOne(id: ChatsFindOnePathParamsType['id'], config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function chatsFindOneQueryOptions(id: ChatsFindOnePathParamsType['id'], config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<ChatsFindOneQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
