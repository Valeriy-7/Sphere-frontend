...
export const chatsFindAllSuspenseQueryKey = (params: ChatsFindAllQueryParamsType) =>
 ...
 * {@link /chats}
 */
export async function chatsFindAllSuspense(
...
export function chatsFindAllSuspenseQueryOptions(
  params: ChatsFindAllQueryParamsType,
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
