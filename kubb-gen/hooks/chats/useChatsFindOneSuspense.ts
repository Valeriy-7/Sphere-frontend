...
export const chatsFindOneSuspenseQueryKey = (id: ChatsFindOnePathParamsType['id']) =>
 ...
 * {@link /chats/:id}
 */
export async function chatsFindOneSuspense(
...
export function chatsFindOneSuspenseQueryOptions(
  id: ChatsFindOnePathParamsType['id'],
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
