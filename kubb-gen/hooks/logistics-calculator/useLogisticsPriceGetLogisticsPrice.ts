...
export type LogisticsPriceGetLogisticsPriceQueryKey = ReturnType<typeof logisticsPriceGetLogisticsPriceQueryKey>
...
>(
  ...
  const query = useQuery({
    ...(logisticsPriceGetLogisticsPriceQueryOptions(params, config) as unknown as QueryObserverOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<QueryObserverOptions, 'queryKey'>),
  }) as UseQueryResult<TData, ResponseErrorConfig<LogisticsPriceGetLogisticsPrice404Type>> & { queryKey: TQueryKey }
