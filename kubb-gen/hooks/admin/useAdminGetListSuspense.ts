...
} from '../../types/admin/AdminGetListType';
import { queryOptions, useSuspenseQuery } from '@tanstack/react-query';

export const adminGetListSuspenseQueryKey = (params?: AdminGetListQueryParamsType) =>
  [{ url: '/admin/list' }, ...(params ? [params] : [])] as const;
 ...
 * {@link /admin/list}
 */
export async function adminGetListSuspense(
  params?: AdminGetListQueryParamsType,
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
  const { client: request = client, ...requestConfig } = config;

  const res = await request<AdminGetListQueryResponseType, ResponseErrorConfig<Error>, unknown>({
    method: 'GET',
    url: `/admin/list`,
    params,
    ...requestConfig,
...
export function adminGetListSuspenseQueryOptions(
  params?: AdminGetListQueryParamsType,
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
