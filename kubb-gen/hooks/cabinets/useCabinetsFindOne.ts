...
/**
 * @description     Возвращает детальную информацию о конкретном кабинете.    ### Возвращаемые данные:    - Основная информация о компании    - Юридический и фактический адреса    - Контактные данные    - Банковские реквизиты    - Статусы и настройки    - Токен кабинета для аутентификации
 * @summary Получение информации о кабинете
 * {@link /cabinets/:id}
 */
export async function cabinetsFindOne(id: CabinetsFindOnePathParamsType['id'], config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function cabinetsFindOneQueryOptions(id: CabinetsFindOnePathParamsType['id'], config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<CabinetsFindOneQueryResponseType, ResponseErrorConfig<CabinetsFindOne404Type>, TData, TQueryData, TQueryKey>>
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<CabinetsFindOne404Type>> & { queryKey: TQueryKey }
