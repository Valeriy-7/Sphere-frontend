...
export const cabinetsGetAvailablePartnersQueryKey = (params?: CabinetsGetAvailablePartnersQueryParamsType) =>
  [{ url: '/cabinets/available-partners' }, ...(params ? [params] : [])] as const

export type CabinetsGetAvailablePartnersQueryKey = ReturnType<typeof cabinetsGetAvailablePartnersQueryKey>
...
>(
  params?: CabinetsGetAvailablePartnersQueryParamsType,
  options: {
    query?: Partial<QueryObserverOptions<CabinetsGetAvailablePartnersQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>>
  ...
  const query = useQuery({
    ...(cabinetsGetAvailablePartnersQueryOptions(params, config) as unknown as QueryObserverOptions),
    queryKey,
