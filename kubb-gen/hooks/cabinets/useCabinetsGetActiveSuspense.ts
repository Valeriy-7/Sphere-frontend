...
} from '../../types/cabinets/CabinetsGetActiveType';
import { queryOptions, useSuspenseQuery } from '@tanstack/react-query';

export const cabinetsGetActiveSuspenseQueryKey = () => [{ url: '/cabinets/active' }] as const;

export type CabinetsGetActiveSuspenseQueryKey = ReturnType<
  typeof cabinetsGetActiveSuspenseQueryKey
>;
 ...
 */
export async function cabinetsGetActiveSuspense(
  ...
  const res = await request<
    CabinetsGetActiveQueryResponseType,
    ResponseErrorConfig<CabinetsGetActive404Type>,
    unknown
  >({
    method: 'GET',
    url: `/cabinets/active`,
...
export function cabinetsGetActiveSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
...
>(
  ...
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<CabinetsGetActive404Type>> & {
    queryKey: TQueryKey;
  };
