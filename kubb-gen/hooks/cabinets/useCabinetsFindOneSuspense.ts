...
export const cabinetsFindOneSuspenseQueryKey = (id: CabinetsFindOnePathParamsType['id']) =>
 ...
 * {@link /cabinets/:id}
 */
export async function cabinetsFindOneSuspense(
...
export function cabinetsFindOneSuspenseQueryOptions(
  id: CabinetsFindOnePathParamsType['id'],
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
...
>(
  ...
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<CabinetsFindOne404Type>> & {
    queryKey: TQueryKey;
  };
