 ...
 */
export async function cabinetsGetActive(
...
export function cabinetsGetActiveQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
...
>(
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<CabinetsGetActive404Type>> & {
    queryKey: TQueryKey;
  };
