...
export const cabinetsGetAvailablePartnersSuspenseQueryKey = (params?: CabinetsGetAvailablePartnersQueryParamsType) =>
  [{ url: '/cabinets/available-partners' }, ...(params ? [params] : [])] as const

export type CabinetsGetAvailablePartnersSuspenseQueryKey = ReturnType<typeof cabinetsGetAvailablePartnersSuspenseQueryKey>
...
export async function cabinetsGetAvailablePartnersSuspense(
  ...
  const res = await request<CabinetsGetAvailablePartnersQueryResponseType, ResponseErrorConfig<Error>, unknown>({
    method: 'GET',
...
>(
  params?: CabinetsGetAvailablePartnersQueryParamsType,
  options: {
    query?: Partial<UseSuspenseQueryOptions<CabinetsGetAvailablePartnersQueryResponseType, ResponseErrorConfig<Error>, TData, TQueryKey>>
  ...
  const query = useSuspenseQuery({
    ...(cabinetsGetAvailablePartnersSuspenseQueryOptions(params, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
