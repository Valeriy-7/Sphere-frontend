...
export const logisticsProvidersDeleteLogisticsProviderMutationKey = () => [{ url: '/ff-account/logistics-providers/{id}' }] as const

export type LogisticsProvidersDeleteLogisticsProviderMutationKey = ReturnType<typeof logisticsProvidersDeleteLogisticsProviderMutationKey>
...
export function useLogisticsProvidersDeleteLogisticsProvider<TContext>(
  ...
  const mutationKey = mutationOptions?.mutationKey ?? logisticsProvidersDeleteLogisticsProviderMutationKey()
