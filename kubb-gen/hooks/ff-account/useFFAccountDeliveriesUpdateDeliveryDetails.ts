...
export const FFAccountDeliveriesUpdateDeliveryDetailsMutationKey = () =>
  [{ url: '/ff-account/deliveries/{id}/details' }] as const;

export type FFAccountDeliveriesUpdateDeliveryDetailsMutationKey = ReturnType<
  typeof FFAccountDeliveriesUpdateDeliveryDetailsMutationKey
>;
...
export async function FFAccountDeliveriesUpdateDeliveryDetails(
  ...
  config: Partial<RequestConfig<FFAccountDeliveriesUpdateDeliveryDetailsMutationRequestType>> & {
...
export function useFFAccountDeliveriesUpdateDeliveryDetails(
  ...
  const mutationKey =
    mutationOptions?.mutationKey ?? FFAccountDeliveriesUpdateDeliveryDetailsMutationKey();
