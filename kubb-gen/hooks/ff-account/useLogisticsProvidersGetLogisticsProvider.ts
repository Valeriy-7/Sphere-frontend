...
export const logisticsProvidersGetLogisticsProviderQueryKey = (id: LogisticsProvidersGetLogisticsProviderPathParamsType['id']) =>
  [{ url: '/ff-account/logistics-providers/:id', params: { id: id } }] as const

export type LogisticsProvidersGetLogisticsProviderQueryKey = ReturnType<typeof logisticsProvidersGetLogisticsProviderQueryKey>
...
>(
  ...
  const query = useQuery({
    ...(logisticsProvidersGetLogisticsProviderQueryOptions(id, config) as unknown as QueryObserverOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<QueryObserverOptions, 'queryKey'>),
  }) as UseQueryResult<TData, ResponseErrorConfig<LogisticsProvidersGetLogisticsProvider404Type>> & { queryKey: TQueryKey }
