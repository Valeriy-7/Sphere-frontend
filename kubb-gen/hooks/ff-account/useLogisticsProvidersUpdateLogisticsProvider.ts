...
export const logisticsProvidersUpdateLogisticsProviderMutationKey = () =>
  [{ url: '/ff-account/logistics-providers/{id}' }] as const;

export type LogisticsProvidersUpdateLogisticsProviderMutationKey = ReturnType<
  typeof logisticsProvidersUpdateLogisticsProviderMutationKey
>;
...
export async function logisticsProvidersUpdateLogisticsProvider(
  ...
  config: Partial<RequestConfig<LogisticsProvidersUpdateLogisticsProviderMutationRequestType>> & {
...
export function useLogisticsProvidersUpdateLogisticsProvider(
  ...
  const mutationKey =
    mutationOptions?.mutationKey ?? logisticsProvidersUpdateLogisticsProviderMutationKey();
