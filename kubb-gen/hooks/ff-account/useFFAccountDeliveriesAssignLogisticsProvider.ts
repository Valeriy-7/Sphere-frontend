...
export const FFAccountDeliveriesAssignLogisticsProviderMutationKey = () => [{ url: '/ff-account/deliveries/{id}/assign-logistics-provider' }] as const
 ...
 * {@link /ff-account/deliveries/:id/assign-logistics-provider}
 */
export async function FFAccountDeliveriesAssignLogisticsProvider(
  ...
  const res = await request<
    ...
    FFAccountDeliveriesAssignLogisticsProviderMutationRequestType
  >({ method: 'PATCH', url: `/ff-account/deliveries/${id}/assign-logistics-provider`, data, ...requestConfig })
  return res.data
}
