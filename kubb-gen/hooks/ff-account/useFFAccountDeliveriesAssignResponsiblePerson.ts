...
export const FFAccountDeliveriesAssignResponsiblePersonMutationKey = () => [{ url: '/ff-account/deliveries/{id}/responsible-person' }] as const

export type FFAccountDeliveriesAssignResponsiblePersonMutationKey = ReturnType<typeof FFAccountDeliveriesAssignResponsiblePersonMutationKey>
...
export async function FFAccountDeliveriesAssignResponsiblePerson(
  ...
  config: Partial<RequestConfig<FFAccountDeliveriesAssignResponsiblePersonMutationRequestType>> & { client?: typeof client } = {},
) {
  ...
  const res = await request<
    ...
    FFAccountDeliveriesAssignResponsiblePersonMutationRequestType
  >({ method: 'PATCH', url: `/ff-account/deliveries/${id}/responsible-person`, data, ...requestConfig })
  return res.data
}
...
export function useFFAccountDeliveriesAssignResponsiblePerson<TContext>(
  options: {
    mutation?: UseMutationOptions<
      FFAccountDeliveriesAssignResponsiblePersonMutationResponseType,
      ResponseErrorConfig<FFAccountDeliveriesAssignResponsiblePerson404Type>,
      { id: FFAccountDeliveriesAssignResponsiblePersonPathParamsType['id']; data: FFAccountDeliveriesAssignResponsiblePersonMutationRequestType },
      TContext
    >
    client?: Partial<RequestConfig<FFAccountDeliveriesAssignResponsiblePersonMutationRequestType>> & { client?: typeof client }
  } = {},
) {
  const { mutation: mutationOptions, client: config = {} } = options ?? {}
  const mutationKey = mutationOptions?.mutationKey ?? FFAccountDeliveriesAssignResponsiblePersonMutationKey()
