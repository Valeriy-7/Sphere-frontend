...
export const FFAccountDeliveriesGetDeliveriesQueryKey = (
  params?: FFAccountDeliveriesGetDeliveriesQueryParamsType,
) => [{ url: '/ff-account/deliveries' }, ...(params ? [params] : [])] as const;

export type FFAccountDeliveriesGetDeliveriesQueryKey = ReturnType<
  typeof FFAccountDeliveriesGetDeliveriesQueryKey
>;

/**
 * @description Возвращает список поставок с возможностью фильтрации по статусу и периоду дат. Также включает сводную информацию о поставках.
