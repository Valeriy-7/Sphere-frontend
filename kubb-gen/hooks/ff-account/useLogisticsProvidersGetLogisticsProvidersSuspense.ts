...
export const logisticsProvidersGetLogisticsProvidersSuspenseQueryKey = () =>
  [{ url: '/ff-account/logistics-providers' }] as const;

export type LogisticsProvidersGetLogisticsProvidersSuspenseQueryKey = ReturnType<
  typeof logisticsProvidersGetLogisticsProvidersSuspenseQueryKey
>;
 ...
 */
export async function logisticsProvidersGetLogisticsProvidersSuspense(
...
export function logisticsProvidersGetLogisticsProvidersSuspenseQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? logisticsProvidersGetLogisticsProvidersSuspenseQueryKey();
