...
export type LogisticsProvidersGetLogisticsProviderSuspenseQueryKey = ReturnType<typeof logisticsProvidersGetLogisticsProviderSuspenseQueryKey>
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? logisticsProvidersGetLogisticsProviderSuspenseQueryKey(id)

  const query = useSuspenseQuery({
    ...(logisticsProvidersGetLogisticsProviderSuspenseQueryOptions(id, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<LogisticsProvidersGetLogisticsProvider404Type>> & { queryKey: TQueryKey }
