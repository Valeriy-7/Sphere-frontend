...
export const deliveriesGetSuppliersSuspenseQueryKey = () => [{ url: '/deliveries/suppliers' }] as const

export type DeliveriesGetSuppliersSuspenseQueryKey = ReturnType<typeof deliveriesGetSuppliersSuspenseQueryKey>
 ...
 */
export async function deliveriesGetSuppliersSuspense(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function deliveriesGetSuppliersSuspenseQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  options: {
    query?: Partial<UseSuspenseQueryOptions<DeliveriesGetSuppliersQueryResponseType, ResponseErrorConfig<DeliveriesGetSuppliers401Type>, TData, TQueryKey>>
  ...
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<DeliveriesGetSuppliers401Type>> & { queryKey: TQueryKey }
