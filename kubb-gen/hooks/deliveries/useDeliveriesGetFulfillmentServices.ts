...
export const deliveriesGetFulfillmentServicesQueryKey = () => [{ url: '/deliveries/services' }] as const

export type DeliveriesGetFulfillmentServicesQueryKey = ReturnType<typeof deliveriesGetFulfillmentServicesQueryKey>
 ...
 */
export async function deliveriesGetFulfillmentServices(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
export function deliveriesGetFulfillmentServicesQueryOptions(config: Partial<RequestConfig> & { client?: typeof client } = {}) {
...
>(
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<DeliveriesGetFulfillmentServices401Type>> & { queryKey: TQueryKey }
