 ...
 */
export async function deliveriesGetSuppliers(
...
export function deliveriesGetSuppliersQueryOptions(
  config: Partial<RequestConfig> & { client?: typeof client } = {},
) {
...
>(
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<DeliveriesGetSuppliers401Type>> & {
    queryKey: TQueryKey;
  };
