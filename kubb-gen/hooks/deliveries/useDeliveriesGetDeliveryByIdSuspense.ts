...
export const deliveriesGetDeliveryByIdSuspenseQueryKey = (id: DeliveriesGetDeliveryByIdPathParamsType['id']) =>
  [{ url: '/deliveries/:id', params: { id: id } }] as const

export type DeliveriesGetDeliveryByIdSuspenseQueryKey = ReturnType<typeof deliveriesGetDeliveryByIdSuspenseQueryKey>
...
>(
  ...
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<DeliveriesGetDeliveryByIdQueryResponseType, ResponseErrorConfig<DeliveriesGetDeliveryById404Type>, TData, TQueryKey>
    >
  ...
  const query = useSuspenseQuery({
    ...(deliveriesGetDeliveryByIdSuspenseQueryOptions(id, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<DeliveriesGetDeliveryById404Type>> & { queryKey: TQueryKey }
