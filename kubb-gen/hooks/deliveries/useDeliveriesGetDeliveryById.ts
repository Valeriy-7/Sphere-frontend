...
export const deliveriesGetDeliveryByIdQueryKey = (
  id: DeliveriesGetDeliveryByIdPathParamsType['id'],
) => [{ url: '/deliveries/:id', params: { id: id } }] as const;

export type DeliveriesGetDeliveryByIdQueryKey = ReturnType<
  typeof deliveriesGetDeliveryByIdQueryKey
>;
...
>(
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<DeliveriesGetDeliveryById404Type>> & {
    queryKey: TQueryKey;
  };
