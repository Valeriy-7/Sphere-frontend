...
export const logisticsSchema = z.object({
  ...
  fromPointType: z.enum(['WILDBERRIES', 'FULFILLMENT', 'MARKETPLACE']).describe('Тип точки отправления'),
  toPointType: z.enum(['WILDBERRIES', 'FULFILLMENT', 'MARKETPLACE']).describe('Тип точки назначения'),
