...
export const logisticsUpdateConsumableMutationRequestSchema = z.lazy(() => createConsumableDtoSchema)

export const logisticsUpdateConsumableMutationResponseSchema = z.lazy(() => logisticsUpdateConsumable200Schema)