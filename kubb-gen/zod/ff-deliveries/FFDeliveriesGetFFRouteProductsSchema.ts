 ...
 */
export const FFDeliveriesGetFFRouteProducts200Schema = z.array(z.lazy(() => FFDeliveryProductDtoSchema))
...
export const FFDeliveriesGetFFRouteProductsQueryResponseSchema = z.lazy(() => FFDeliveriesGetFFRouteProducts200Schema)