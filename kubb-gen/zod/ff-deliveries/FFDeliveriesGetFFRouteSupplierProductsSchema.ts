 ...
 */
export const FFDeliveriesGetFFRouteSupplierProducts200Schema = z.array(z.lazy(() => FFDeliveryProductDtoSchema))
...
export const FFDeliveriesGetFFRouteSupplierProductsQueryResponseSchema = z.lazy(() => FFDeliveriesGetFFRouteSupplierProducts200Schema)