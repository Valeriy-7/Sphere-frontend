...
export const FFDeliveriesUpdateStatusMutationRequestSchema = z.lazy(() => updateDeliveryStatusDtoSchema)

export const FFDeliveriesUpdateStatusMutationResponseSchema = z.lazy(() => FFDeliveriesUpdateStatus200Schema)