 ...
 */
export const FFAccountDeliveriesAssignResponsiblePersonMutationRequestSchema = z.lazy(
  () => assignResponsiblePersonDtoSchema,
);

export const FFAccountDeliveriesAssignResponsiblePersonMutationResponseSchema = z.lazy(
  () => FFAccountDeliveriesAssignResponsiblePerson200Schema,
);
