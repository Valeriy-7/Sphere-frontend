...
export const FFAccountDeliveriesGetDeliveriesQueryParamsSchema = z
  .object({
    ...
    deliveryDate: z.string().describe('Конкретная дата поставки в формате ISO (YYYY-MM-DD). Если указана, то startDate и endDate игнорируются.').optional(),
 ...
 */
export const FFAccountDeliveriesGetDeliveries200Schema = z.lazy(() => FFDeliveryWithRoutesListResponseDtoSchema)

export const FFAccountDeliveriesGetDeliveriesQueryResponseSchema = z.lazy(() => FFAccountDeliveriesGetDeliveries200Schema)