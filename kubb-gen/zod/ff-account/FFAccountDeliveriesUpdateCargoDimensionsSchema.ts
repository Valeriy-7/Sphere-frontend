 ...
 */
export const FFAccountDeliveriesUpdateCargoDimensionsMutationRequestSchema = z.lazy(
  () => updateCargoDimensionsDtoSchema,
);

export const FFAccountDeliveriesUpdateCargoDimensionsMutationResponseSchema = z.lazy(
