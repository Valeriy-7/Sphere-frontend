 ...
 */
export const logisticsProvidersCreateLogisticsProvider201Schema = z.lazy(
 ...
 */
export const logisticsProvidersCreateLogisticsProviderMutationRequestSchema = z.lazy(
  () => createLogisticsProviderDtoSchema,
);

export const logisticsProvidersCreateLogisticsProviderMutationResponseSchema = z.lazy(
