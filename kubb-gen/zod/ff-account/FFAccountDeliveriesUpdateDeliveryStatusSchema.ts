 ...
 */
export const FFAccountDeliveriesUpdateDeliveryStatusMutationRequestSchema = z.lazy(
  () => updateDeliveryStatusDtoSchema,
);

export const FFAccountDeliveriesUpdateDeliveryStatusMutationResponseSchema = z.lazy(
