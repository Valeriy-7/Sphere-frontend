 ...
 */
export const FFAccountDeliveriesUpdateStoreInfoMutationRequestSchema = z.lazy(() => updateStoreInfoDtoSchema)

export const FFAccountDeliveriesUpdateStoreInfoMutationResponseSchema = z.lazy(() => FFAccountDeliveriesUpdateStoreInfo200Schema)