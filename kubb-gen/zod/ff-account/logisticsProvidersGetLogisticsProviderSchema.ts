 ...
 */
export const logisticsProvidersGetLogisticsProvider200Schema = z.lazy(() => logisticsProviderListItemDtoSchema)
...
export const logisticsProvidersGetLogisticsProviderQueryResponseSchema = z.lazy(() => logisticsProvidersGetLogisticsProvider200Schema)