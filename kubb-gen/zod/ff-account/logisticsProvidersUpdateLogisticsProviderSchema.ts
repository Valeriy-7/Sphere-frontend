 ...
 */
export const logisticsProvidersUpdateLogisticsProvider200Schema = z.lazy(() => logisticsProviderListItemDtoSchema)
 ...
 */
export const logisticsProvidersUpdateLogisticsProviderMutationRequestSchema = z.lazy(() => updateLogisticsProviderDtoSchema)

export const logisticsProvidersUpdateLogisticsProviderMutationResponseSchema = z.lazy(() => logisticsProvidersUpdateLogisticsProvider200Schema)