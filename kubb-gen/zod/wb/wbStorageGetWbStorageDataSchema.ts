 ...
 */
export const wbStorageGetWbStorageData200Schema = z.object({
  summary: z
    .object({
      currentStock: z
        .object({
 ...
 */
export const wbStorageGetWbStorageData401Schema = z.any()

export const wbStorageGetWbStorageDataQueryResponseSchema = z.lazy(() => wbStorageGetWbStorageData200Schema)