...
export const authUserDataDtoSchema = z.object({
  ...
  regStatus: z.enum(['incomplete', 'complete', 'verified']).describe('Статус регистрации пользователя'),
  cabinets: z.array(z.lazy(() => cabinetShortDataDtoSchema)).describe('Список кабинетов пользователя'),
})