...
export function StorageTable({
  ...
  return (
    ...
    >
      <Table className={"text-center w-full table-fixed relative"} {...props}>
        <TableHeader>
          <TableRowHeader />
          <TableRowFilter />
        </TableHeader>
        <TableBody>
          ...
          <tr>
            <td
              className={"bg-white dark:bg-transparent rounded-lg border py-2"}
              colSpan={18}
            >
              <ScrollArea
  ...
  <>
    <TableRow>
      ...
      <TableCell className={"w-[calc(var(--storage-column-head)*2)]"}>
        <Card className={"p-1 inline-flex items-center gap-2 max-w-[165px]"}>
          <img
...
const TableRowProduct = () => (
  <>
    <TableRow rowSpace={"xs"}>
      <TableCell
        className={"sticky top-[20px] w-[--storage-column-icon]"}
        level={1}
      >
        1
      </TableCell>
      <TableCell
        className={"sticky top-[20px] w-[--storage-column-head]"}
        level={1}
      >
